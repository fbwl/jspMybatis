	...
	<table border="1" align="center" width="80%">
		...
		<tr>
			...
			<td>
				...
				<c:if test="${dto.gender.equals('F') }">
					...
					<input type="text" id="gender" name="gender" value="F">
				</c:if>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="postcode" id="sample6_postcode"
				placeholder="우편번호" value="${dto.postcode }"> <input type="button"
				onclick="sample6_execDaumPostcode()" value="우편번호 찾기"> <input
				type="text" name="address" id="sample6_address" placeholder="주소" value="${dto.address }">
				<br> <input type="text" id="sample6_detailAddress"
				placeholder="상세주소" name="detailAddress" value="${dto.detailAddress }"> <input type="text"
				id="sample6_extraAddress" placeholder="참고항목" name="extraAddress"  value="${dto.extraAddress }"></td>

		</tr>
		<tr>
			<td colspan="2" align="center"><input type="button"
				onclick="suntaek_proc('modifyProc','','${dto.no}');" value="수정하기"></td>
		</tr>
	</table>
	<script
